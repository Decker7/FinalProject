...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.marketing.breadcrumbs','data' => ['crumbs' => [ ['text' => 'About'] ]]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['crumbs' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([ ['text' => 'About'] ])]); ?>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\FinalProject\resources\views\pages\genesis\about.blade.php ENDPATH**/ ?>